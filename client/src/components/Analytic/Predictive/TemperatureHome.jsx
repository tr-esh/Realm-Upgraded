...
import circleOutlineAnimation from '../../../img/wired-outline-447-water-drop (1).json';  // Replace with the path to your downloaded Lottie file
      ...
      <div className="predictHome-container">
        {prediction ? (
          <div className="predic" style={{ margin: 'auto' }}>
            ...
            />
            <p className='home-result'>{parseFloat(prediction.value).toFixed(2)} °C</p>
